...
media_return.sender as "Sender:Link/Contact:100",
media_return.recipient as "Recipient:Link/Contact:100",
media_return.customer as "Customer:Link/Customer:100",
media_return.project as "Project:Link/Project:100",
...
media_receipt.sender as "Sender:Link/Contact:100",
media_receipt.recipient as "Recipient:Link/Contact:100",
media_receipt.customer as "Customer:Link/Customer:100",
media_receipt.project as "Project:Link/Project:100",
