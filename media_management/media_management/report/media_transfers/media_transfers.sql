...
IF(media_return.docstatus>1, "Cancelled", IF(media_return.docstatus=0, "Draft","Submitted" ))  as "Status:Data:85",
media_return.sender as "Sender:Link/Contact:180",
media_return.recipient as "Recipient:Link/Employee:180",
...
'Receipt' as "Type:Data:60",
media_receipt.transfer_date as `Date::100`,
media_receipt.transfer_method as "Method:Link/Transfer Method:100",
IF(media_receipt.docstatus>1, "Cancelled", IF(media_receipt.docstatus=0, "Draft","Submitted" ))  as "Status:Data:85",
media_receipt.sender as "Sender:Link/Contact:180",
media_receipt.recipient as "Recipient:Link/Employee:180",
